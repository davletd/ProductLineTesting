...
public class MatrixGenerator {
	 ...
	 * @param path
	 */
	public TestSuite getTestSuiteMatrix(String XMLFile, String suiteName) {
	...
	private static TestSuite mergeTestMatrices(ArrayList<TestSuite> lts,String name) {
	...
	public static void main(String[] args) {
		...
		MatrixGenerator r= new MatrixGenerator();
		...
		String sagar_root = new String("/Users/sagarsen/Desktop/CartierDemo/productLineTesting/ProductLineTesting/ProductLineTesting");
					...
					if (indivdir.isDirectory() && !indivdir.getName().contains(".svn")) {
						...
						for (int i=0;i<xmlfiles.length;i++) {
							if (xmlfiles[i].contains(".xml")) {
								...
								TestSuite t = r.getTestSuiteMatrix(root+"/Temp/solutions/"+solDir+"/"+xmlfiles[i], indivtname); 
								
								tests.add(t);
							}
						}

						TestSuite suite = r.mergeTestMatrices(tests, solDir);
		...
		for(int i=0;i<suites.size();i++)
			...
			System.out.println("Test Suite ="+suites.get(i).toVector());
	}
